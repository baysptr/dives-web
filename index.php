...
<main role="main" class="container">
    <div class="jumbotron">
        <h1>Identification Vehicles (DiVes)</h1>
        <p class="lead">Selamat datang di halaman utama dalam konfigurasi dan monitoring data</p>
        <a class="btn btn-lg btn-primary" href="manage_data.php" role="button">Manage Data &raquo;</a>
    </div>
</main>
